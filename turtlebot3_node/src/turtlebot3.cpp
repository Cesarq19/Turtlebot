...
{
  DynamixelSDKWrapper::Device u2d2 = {usb_port, 0, 1, 57600, 2.0f};

  this->declare_parameter<uint8_t>("u2d2.motor_right_id");
  this->declare_parameter<uint8_t>("u2d2.motor_left_id");
  this->declare_parameter<int>("u2d2.baud_rate");
  this->declare_parameter<float>("u2d2.protocol_version");

  this->get_parameter_or<uint8_t>("u2d2.motor_right_id", u2d2.motor_right_id, 0);
  this->get_parameter_or<uint8_t>("u2d2.motor_left_id", u2d2.motor_left_id, 1);
